...
pdftitle={OD\&D -- Eldritch Wizardry -- Sorcellerie Occulte -- Pouvoirs psioniques},
pdfkeywords={jdr,D\&D,0e,ODD,Gygax,Blume,TTRPG},
pdfsubject={OD\&D -- Eldritch Wizardry -- Sorcellerie Occulte -- Pouvoirs psioniques},
...
%+-=+-=+-=+-=+-=+-=+-=+-=+-=+-=+-=+-=+-=+-=+-=+-=+-=+-=+-=+-=+-=+-=+-= COVER
\includepdf[scale=0.98]{pagedegarde2.pdf}
...
{\Huge \ODDtitlebisfont{SORCELLERIE}}

\vspace{0.3cm}

{\Huge \ODDtitlebisfont{OCCULTE}}
