...
%++++++++APTITUDE
\pdfbookmark[4]{Altération de la forme}{custom-magicien-alteration-forme}\phantomsection\label{magicien-alteration-forme}\textbf{\uline{Altération de la forme (spécial)}} : ce pouvoir est assez similaire au sort de métamorphose (voir page \pageref{sort-metamorphose}).
