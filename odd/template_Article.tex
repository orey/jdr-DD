...
\newpage
%==========================================================================SECTION
\phantomsection\section*{POUVOIRS PSIONIQUES}
\addcontentsline{toc}{section}{POUVOIRS PSIONIQUES}
...
\begin{enumerate}
\item Le joueur lance 1d20 et consulte la table relative à sa classe ; il rejoue si l'aptitude déterminée par le jet est déjà en sa possession ;
...
\item Il note sur son annexe à la feuille de personnage à quel niveau il a reçu son ou ses aptitudes.
\end{enumerate}
...
\begin{itemize}
\item Le personnage ne peut pas disposer de plus d'aptitudes supérieures qu'il ne possède d'aptitudes inférieures (voir les tables d'aptitudes par classe de personnage). En cas de problème, relancer 1d20 jusqu'à ce que la contrainte soit remplie.
...
\phantomsection\subsection*{Progression}
\addcontentsline{toc}{subsection}{Progression}
...
\phantomsection\subsection*{Annexe à la feuille de personnage}
\addcontentsline{toc}{subsection}{Annexe à la feuille de personnage}
...
Il relance 1d100 sous le potentiel psychique et obtient un 15. Son MD lui propose d'utiliser l'option 2 avec 1d50. Il fait 8 et 2 aux d10 ce qui lui donne 32. Il obtient A:13, Contrôle de l'esprit sur le corps. Il peut la prendre dans la mesure où il n'a pas plus d'aptitudes supérieures que d'aptitudes inférieures.
...
\hline
& \textbf{Niveau} &&&\\
\textbf{Catégorie} & \textbf{d'acquisition}  & \textbf{Aptitude} & \textbf{Type} & \textbf{Malus}  \\ \hline
A & 4 & Réduction                           & Basique & \\ \hline
A & 4 & Contrôle de l'esprit sur le corps   & Supérieure & \\ \hline
\end{tabular}

\bigskip

Plus tard, Rustik passe au niveau 5. Sa chance d'obtenir une aptitude est maintenant de 5 x 11 = 55 \%. Il joue et rate.

\bigskip

Plus tard encore, Rustik passe au niveau 6. Il lance 1d100 et obtient 23 ce qui est inférieur à 67. Il choisit de déterminer son aptitude avec 1d20. Il tire un 18 mais ne peut pas l'avoir car il aurait plus d'aptitudes supérieures que d'aptitudes basiques. Il rejoue et fait 11, ce qui octroie le pouvoir Clairvoyance.
...
A & 4 & Réduction                           & Basique & \\ \hline
A & 4 & Contrôle de l'esprit sur le corps   & Supérieure & \\ \hline
C & 6 & Clairvoyance                        & Basique & \\ \hline
A & 6 & Télékinésie                         & Supérieure & -1 FOR\\ \hline
\end{tabular}
...
\textbf{FOR} & \textbf{CON} & \textbf{DEX} & \textbf{INT} & \textbf{SAG} & \textbf{CHA} \\ \hline
16-1=15 & 13 & 10 & \textbf{15} & 9 & 8 \\ \hline
\end{tabular}
