...
Cette section n'est pas dans le supplément original \texttt{Eldritch Wizardry} ; c'est une synthèse et une réorganisation des règles ayant pour but de les rendre plus accessibles.
...
\begin{itemize}
\item Etre humain,
\item Pas de restriction de classe\footnote{L'édition originale indique que les moines ou les druides ne peuvent pas avoir de pouvoirs mentaux, ce qui est quand même étrange. Plus loi, dans la description des aptitudes psychiques, les aptitudes sont données pour les clercs, les moines et les druides. Nous avons donc choisi, dans cette synthèse, de ne pas retenir la restriction de classes.}
...
Le joueur doit dans la foulée un jet de 1d100 sous sa chance de gagner une aptitude psionique.

\subsection*{Aptitudes psioniques}

\subsubsection*{\textit{Gain}}

Si le jet de 1d100 sous la Chance de gagner une aptitude psionique est réussi :
\begin{enumerate}
\item Le joueur lance 1d20 et consulte la table relative à sa classe ;
\item Le joueur lance 1d100 sous son potentiel psychique ; si le jet est réussi, il gagne une seconde aptitude psionique.
\end{enumerate}
...
Notes :
\begin{itemize}
\item Le personnage ne peut pas disposer de plus d'aptitudes supérieures qu'il ne possède d'aptitudes inférieures. En cas de violation de cette règle, relancer 1d20 jusqu'à ce que la contrainte soit remplie.
\item Si la chance de gagner une aptitude psionique est supérieure à 100\%, alors le joueur peut choisir librement son aptitude.
\item Option : les aptitudes psioniques sont réparties par catégorie (de A à D). Au lieu de lancer 1d20, l'arbitre peut choisir de restreindre les choix à des catégories connexes des aptitudes déjà possédées par le personnage. \footnote{C'est un des moyens pour remplir l'exigence originale : \og Dans la sélection aléatoire, il est suggéré de mettre un poids supérieur
aux probabilités de gain d’aptitudes liées à des aptitudes déjà possédées, par exemple Empathie
augmenterait les chances de gagner Perception extrasensorielle, Télépathie animale et Projection télépathique\fg{}.}. Voir la table Choix d'aptitude par catégorie après la table relative à chaque classe de personnages.
\end{itemize}

\subsubsection*{\textit{Aptitudes psioniques par catégorie}}

Les aptitudes psioniques ont été classées en quatre catégories :
\begin{itemize}
...
1 & A:1 & Réduction & 13 & A:9 & Contrôle de l'énergie  \\
2 & A:2 & Expansion & 14 & A:10 & Télékinésie \\
3 & A:3 &Lévitation & 15 & D:1 & Marche dimensionnelle \\
4 & B:1 & Domination  & 16 & D:2 &Projection astrale  \\
5 & A:4 & Contrôle de l'esprit sur le corps & 17 & A:11 & Réarrangement moléculaire \\
6 & A:5 & Invisibilité & 18 & A:12 & Manipulation moléculaire \\
7 & C:1 & Prémonition  & 19 & A:13 & Contrôle de l'esprit sur le corps \\
8 & A:6 & Hibernation & 20 & B:2 & Barrière mentale \\
9 & A:7 & Changer le poids du corps  &&& \\
10 & C:2 & Clairaudience &&& \\
11 & C:3 & Clairvoyance  &&& \\
12 & A:8 & Corps comme arme &&& \\
\end{tabular}
...
\begin{center}
\begin{tabular}{ccl}
\multicolumn{3}{c}{OPTION : CHOIX D'APTITUDE PAR CATEGORIE} \\
\textbf{Catégorie} &  \textbf{Nb d'aptitudes} & \textbf{Jet} \\
...
\begin{itemize}
\item Un impact sur les modes d'attaque et les modes de défense,
\item Un impact sur la baisse des caractéristiques ou avantages du personnage.
\end{itemize}



\subsection*{Modes d'attaques et modes de défense}
...
\textbf{Classe} & \textbf{Toutes les} & \textbf{Perte}\\
Guerrier & 4 aptitudes psioniques & 1 pt de Force \\
Magicien & 1 aptitude psionique & Des niveaux de sort correspondant au nombre d'aptitudes psioniques \\
&& 1\textsuperscript{ère} aptitude : 1 niveau de sorts (un sort de niveau 1) \\
...
Gagner des aptitudes psioniques

A chaque passage de niveau, le joueur doit lancer 1d100 sous sa chance de gagner une aptitude psionique
...
\subsection*{Annexe à la feuille de personnage}

Exemple de personnage : Rustik, guerrier, a réussi son jet de psionique alors qu'il est de niveau 4.
...
Il dispose donc de 4 x 11\% = 44\% d'avoir une aptitude psionique. Il lance 1d100 et obtient 31.

Il lance 1d20 sur la table des aptituds psioniques
