...
%----------------------------------------------------- SUB SECTION
\phantomsection\subsection*{SYSTEME DE COMBAT ALTERNATIF\footnote{Alternatif à Chainmail, mais devenu le système standard de OD\&D (NdT).}}
...
\textbf{MATRICE D'ATTAQUE 1 : HOMMES ATTAQUANT}\footnote{Les tables présentées possèdent le même contenu que la table originale (et ses commentaires) mais la première permet de voir les niveaux de progression directement par classe de personnages (NdT).}
...
\phantomsection\label{sort-clairvoyance}\textbf{Clairvoyance} : comme le sort Perception extrasensorielle excepté que le lanceur du sort peut visualiser au lieu de détecter des pensées.

\bigskip

\phantomsection\label{sort-clairaudience}\textbf{Clairaudience} : comme le sort de Clairvoyance excepté qu'il permet d'entendre plutôt que de voir. C'est un des rares sorts qui peut être lancé au travers d'une boule de cristal.
